...
// get veterans data and employee data
router.route("/veteran").get(protectRoute, isAdmin, getAllVeterans);
router.route("/employee").get(protectRoute, isAdmin, getAllEmployees);

// veteran approval, employee approval
router.route("/approval-vet-emp").post(protectRoute, isAdmin, approvalEmpVet);
